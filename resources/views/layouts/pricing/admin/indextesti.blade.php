...
<div class="col-md-8">
         ...
         <tr>
             ...
             <td>
                 ...
                 <a href="{{ route('review.edit',$testimonial->id) }}" class="btn btn-primary">
                     <i class="glyphicon glyphicon-edit"></i>
                </a>
             </td>
             <td>
                 <button class="btn btn-danger" data-action="{{ route('review.destroy',$testimonial->id) }}" data-name="{{ $testimonial->texto }}" data-toggle="modal"
